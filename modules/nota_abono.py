...
class GenerarNotaAbono(models.TransientModel):
    _name = "generar.nota.abono"

    def generar_nota_abono(self, factura, correlativo):
        if not factura.reversed_entry_id:
            raise ValidationError(
                "La nota de abono debe ser creada a base de una factura existente."
            )
