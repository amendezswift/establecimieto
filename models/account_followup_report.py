...
class AccountFollowupReport(models.AbstractModel):
    ...
    def _get_followup_report_lines(self, options):
        ...
        for l in partner.unreconciled_aml_ids.sorted().filtered(
            ...
            if (
                l.company_id in self.env.company._accessible_branches()
                and not l.blocked
            ):
                ...
                lines.append(
                    {
                        ...
                        "name": (
                            aml.move_id.numero_dte if aml.move_id.numero_dte else ""
                        ),
